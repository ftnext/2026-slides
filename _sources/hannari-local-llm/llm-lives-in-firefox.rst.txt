...
.. image:: ../_static/hannari-local-llm/firefox-sidebar-ai-controls-select-localhost.png
    :scale: 40%

ボタン1つで **要約させ放題**！
--------------------------------------------------

.. image:: ../_static/hannari-local-llm/firefox-sidebar-ai-control-page-summarize-button.png
    :scale: 60%
