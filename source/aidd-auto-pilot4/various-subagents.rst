...
* にっきー [#nikkie-uuid]_ 、本日公開のインタビューより「Pythonのプロフェッショナル」
...
.. TODO `Codex Ambassador (Tokyo) <https://nikkie-ftnext.hatenablog.com/entry/announcement-one-of-codex-ambassadors-tokyo>`__
    Devin Ambassador

.. [#nikkie-uuid] UUID `28fb3f96-a221-462c-93bd-567b431715b9 <https://x.com/ftnext/status/2041119610368602138>`__

複数コーディングエージェントを *並列* で走らせる
============================================================
...
* superpowersから最近のモデルへとサブエージェントは簡単になってきた
* 私がやってきたのは、巨大な1タスクの分割実装
* Open Question: 複数のタスクをつないで自走させるには？

.. AgentTeamのような路線が自分は未開拓
