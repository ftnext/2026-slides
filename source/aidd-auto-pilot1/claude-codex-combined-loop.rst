...
自走に強い興味 [#2026-auto-pilot-article]_
------------------------------------------------------------
...
* `claude-plugins-official <https://github.com/anthropics/claude-plugins-official/tree/main>`__ marketplaceの `feature-dev <https://github.com/anthropics/claude-plugins-official/tree/main/plugins/feature-dev>`__ プラグイン
...
`Claude Codeを加速させる私の推しスキル・ツール・設定（Findyイベント登壇資料） <https://zenn.dev/ubie_dev/articles/claude-code-tips-findy-2026#%E6%89%8B%E6%88%BB%E3%82%8A%E3%82%92%E6%B8%9B%E3%82%89%E3%81%97%E3%81%9F%E3%81%84>`__

.. https://x.com/ftnext/status/2031577043176157449
...
適用事例：見立て30行 -> 500行（テスト込み）
------------------------------------------------------------

* ある `PEP <https://peps.python.org/pep-0723/#reference-implementation>`__ にあった30行の参照実装をもとに Claude Code で実装（Sonnet 4.6）
* Codex(GPT-5.4)がPythonの仕様を熟知していてコーナーケースを指摘しまくる（10回近く回した。Opus 4.6出動）
* **+500行** の重厚な実装に https://github.com/ftnext/pep723/pull/6
