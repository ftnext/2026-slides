...
.. インスパイア「`魔法少女 俺 <https://magicalgirl-ore.com/>`__」
...
半年過ぎ、コーディングエージェントに任せておける
---------------------------------------------------

* **ランチ休憩** の裏でタスクを振り、それができた状態で再開
* **家事** の裏で個人開発進める
* 「`生産システム <https://youtu.be/qUxjJywT1aw?si=MBy9NG1yVhW9eYmj>`__」・*ファクトリー*
...
* 監督を徹底させたことで、Fableがトークンをそれほど消費しない感覚

.. 図かな（3タブ分割でやっていて -> 3 Fable）
    ウィンドウ分割しまくり、全部チェック（コンテキストスイッチ）

オーケストレータ 俺、適用 **可能性**
============================================================

* Fable以外でも
* ※検証しきれていないアイデアレベルも含みます🙏
...
* Astraに呼び出させましょう
* ⚠️ただしAstraにAstraをサブエージェントに呼び出させるとPlusの枠はマッハで消える
...
.. raw:: html
    ...
    <blockquote class="twitter-tweet" data-lang="ja" data-align="center" data-dnt="true"><p lang="en" dir="ltr">ChatGPT Voice is now in the desktop app.<br><br>Control your computer and direct multiple agents running in ChatGPT Work or Codex, using just your voice. <br><br>It&#39;s powered by GPT-Live, so it can speak, listen, and coordinate work in the app at the same time.<br><br>Rolling out globally today… <a href="https://t.co/ODZWKqecCf">pic.twitter.com/ODZWKqecCf</a></p>&mdash; OpenAI (@OpenAI) <a href="https://x.com/OpenAI/status/2080378182469857576?ref_src=twsrc%5Etfw">2026年7月23日</a></blockquote>

まとめ🌯 オーケストレータ 俺
============================================================

* 自走の新たな選択肢：賢いモデルにサブエージェントを監督させる（プロンプトやskillで指示）
* 優秀なマネージャーの手が空いてる状態になって、いいぞ
* このマネージャを複数使役で100X
